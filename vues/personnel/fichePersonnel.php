...
function afficherFichePersonnel ($donnee,$err)
{
	...
	//!! a transférer dans la partie MODELE dans un script chargeant toutes les listes code&libelle
	...
	"<div id=\"corps\">
		...
		<p>
			<form method=\"post\" action=\"index.php?objet=personnel&action=enregistrer\">";
